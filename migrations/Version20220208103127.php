 ...
 */
final class Version20220208103127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rasgo ADD rasgo_personaje_id INT DEFAULT NULL, ADD personaje_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE rasgo ADD CONSTRAINT FK_67AC8374ED0D04D6 FOREIGN KEY (rasgo_personaje_id) REFERENCES personaje (id)');
        $this->addSql('ALTER TABLE rasgo ADD CONSTRAINT FK_67AC8374121EFAFB FOREIGN KEY (personaje_id) REFERENCES personaje (id)');
        $this->addSql('CREATE INDEX IDX_67AC8374ED0D04D6 ON rasgo (rasgo_personaje_id)');
        $this->addSql('CREATE INDEX IDX_67AC8374121EFAFB ON rasgo (personaje_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rasgo DROP FOREIGN KEY FK_67AC8374121EFAFB');
        $this->addSql('DROP INDEX IDX_67AC8374ED0D04D6 ON rasgo');
        $this->addSql('DROP INDEX IDX_67AC8374121EFAFB ON rasgo');
        $this->addSql('ALTER TABLE rasgo DROP rasgo_personaje_id, DROP personaje_id');
    }
}
